...
$sql = "SELECT vehicles.*,tblbrands.BrandName,tblbrands.id as bid  from vehicles join tblbrands on tblbrands.id=vehicles.VehiclesBrand where vehicles.VehiclesBrand=:brand and vehicles.FuelType=:fueltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query->execute();
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT vehicles.*,tblbrands.BrandName,tblbrands.id as bid  from vehicles join tblbrands on tblbrands.id=vehicles.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
