...
$sql="INSERT INTO  tblcontactusquery(name,Email,ContactNumber,Message) VALUES(:name,:email,:contactno,:message)";
    ...
    <div  class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="contact_detail">
              <?php 
$pagetype=$_GET['type'];
$sql = "SELECT Address,Email,ContactNo from tblcontactusinfo";
$query = $dbh -> prepare($sql);
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com"><?php   echo htmlentities($result->Email); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
