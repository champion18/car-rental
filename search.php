...
join tblbrands on tblbrands.id=vehicles.VehiclesBrand 
where vehicles.VehiclesTitle=:search || vehicles.FuelType=:search || tblbrands.BrandName=:search || vehicles.ModelYear=:search";
