-- phpMyagencies SQL Dump
-- version 5.1.1
-- https://www.phpmyagencies.net/
--
-- Host: 127.0.0.1
...
-- INSERT INTO `agencies` (`id`, `UserName`, `Password`) VALUES
-- (1, 'agencies', '5c428d8875d2948607f3e3fe134d71b4');
...
INSERT INTO `tblcontactusinfo` (`id`, `Address`, `Email`, `ContactNo`) VALUES
...
INSERT INTO `tblcontactusquery` (`id`, `name`, `Email`, `ContactNumber`, `Message`, `PostingDate`, `status`) VALUES
